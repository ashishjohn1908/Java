    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            for (int counter = 0; counter < product_array.length; counter++) {
                ...
                product_array[counter].id = counter + 13;
            ...
            for (int counter = 0; counter < product_array.length; counter++) {
                ...
                myPrepStatement.setInt(2, product_array[counter].typeId);
                myPrepStatement.setString(3, product_array[counter].name);
                myPrepStatement.setString(4, product_array[counter].description);
                myPrepStatement.setDouble(5, product_array[counter].price);
