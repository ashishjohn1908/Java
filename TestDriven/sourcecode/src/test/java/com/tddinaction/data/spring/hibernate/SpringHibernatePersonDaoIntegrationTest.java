...
public class SpringHibernatePersonDaoIntegrationTest extends HibernateIntegrationTestCase {
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(SpringHibernatePersonDaoIntegrationTest.class);
    }
    ...
    private void persist(List<? extends Object> objects, SessionFactory sf) {
