...
public class OrderManager implements Runnable
{
    ...
    private MissedTrade missedTrade = new MissedTrade("OrderManager");
        ...
        try {
            ...
            while ( true ) 
            {
                ...
                for ( int i = 0; i < orderBookKeys.length; i++ )
                {
                    ...
                    if ( sb.sell == null ) {
                        System.out.println("sb.sell is null");
                    }
                    else {
                    ...
                    //
                    if ( sb.buy == null ) {
                        System.out.println("sb.buy is null");
                    }
                    else {
                ...
                if ( waitTime > 0 && waitTime < 2000000 )
    ...
    private boolean checkForTrade(OrderEntry entry, double marketPrice)
    {
        ...
        case OrderType.LIMIT_SELL:
            ...
            {
                missedTrade.sendMissedTrade(entry.getType(), entry.getPrice(), 
                        marketPrice, entry.getSymbol());
                System.out.println(
        ...
        */
        ...
        try {
            ...
            else
            {
                ...
                tradeXML.append(LIMITPRICE_CLOSE);
                /*
                tradeXML.append(STOPPRICE_TAG);
                tradeXML.append(entry.getPrice());
                tradeXML.append(STOPPRICE_CLOSE);
                 */
            }
