...
import java.io.InputStreamReader;                 // for I/O

////////////////////////////////////////////////////////////////
class LinkIn {
    public long dData;             // data item
    public LinkIn next;              // next link in list

    // -------------------------------------------------------------
    public LinkIn(long dd)           // constructor
    {
        dData = dd;
    }
...
////////////////////////////////////////////////////////////////
class LinkListIn {
    private LinkIn first;            // ref to first item on list

    // -------------------------------------------------------------
    public LinkListIn()              // constructor
    {
        first = null;
    }           // no items on list yet

    // -------------------------------------------------------------
    public LinkIn getFirst()         // get value of first
    {
        return first;
    }

    // -------------------------------------------------------------
    public void setFirst(LinkIn f)   // set first to new link
    {
        first = f;
    }
    ...
    public void displayList() {
        LinkIn current = first;       // start at beginning of list
...
////////////////////////////////////////////////////////////////
class ListIterator {
    private LinkIn current;          // current link
    private LinkIn previous;         // previous link
    private LinkListIn ourList;      // our linked list

    //--------------------------------------------------------------
    public ListIterator(LinkListIn list) // constructor
    {
        ourList = list;
        reset();
    }
    ...
    //--------------------------------------------------------------
    public LinkIn getCurrent()       // get current link
    {
        return current;
    }
...
class InterIterApp {
    public static void main(String[] args) throws IOException {
        LinkListIn theList = new LinkListIn();           // new list
